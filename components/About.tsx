...
export default function About() {
  return (
    <section id="about-me" className="max-w-4xl mx-auto px-6 py-24">
      ...
      {/* Bio — centered, comfortable reading width */}
      <p
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="card p-5 flex items-start gap-4">
          ...
          <div>
            <p className="font-mono text-xs tracking-widest uppercase mb-2" style={{ color: '#AB987A' }}>
              Education
            </p>
        ...
        <div className="card p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="font-mono text-xs tracking-widest uppercase" style={{ color: '#AB987A' }}>
              Certifications
            </p>
          </div>
          <div>
            {certs.map((cert, i) => (
              <div key={i}>
                ...
                <p className="font-mono text-xs mt-1" style={{ color: '#AB987A' }}>
